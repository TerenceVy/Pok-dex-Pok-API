...
export default class Pokemon extends Component {
    ...
    async componentDidMount() {
        ...
        if (pokemonRes3.data.chain.evolves_to[0]) {
            const evolves_to2 = pokemonRes3.data.chain.evolves_to[0].species.name;
            if (pokemonRes3.data.chain.evolves_to[0].evolves_to[0]) {
                const evolves_to3 = pokemonRes3.data.chain.evolves_to[0].evolves_to[0].species.name;
            }
        }
        ...
        //const imageUrl2 = pokemonRes3.data;
